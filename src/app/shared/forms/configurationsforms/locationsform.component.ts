...
@Component({
  ...
  styleUrls: ['./locationsform.component.css'],
...
export class LocationsFormComponent implements OnInit {
  ...
  constructor(public akiSettings: AkiSettingsService, public akiroyaltyLoactionsService: AkiroyaltyLocationsService) { }
  ...
  onSubmit(item){
    ...
    this.akiroyaltyLoactionsService
      .putItem(item)
      .subscribe(data => {
          console.log(data);
