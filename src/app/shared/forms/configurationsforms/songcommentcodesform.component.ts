...
@Component({
  selector: 'app-songcommentcodes-form',
  templateUrl: './songcommentcodesform.component.html',
  styleUrls: ['./songcommentcodesform.component.css'],
...
export class SongCommentCodesFormComponent implements OnInit {
  ...
  constructor(public akiSettings: AkiSettingsService, public akiroyaltySongCommentCodesService : AkiroyaltySongCommentCodesService ) { }
  ...
  onSubmit(item){
    ...
    this.akiroyaltySongCommentCodesService
      .putItem(item)
      .subscribe(data => {
          console.log(data);
