...
@Component({
  selector: 'app-ownertypes-form',
  templateUrl: './ownertypesform.component.html',
  styleUrls: ['./ownertypesform.component.css'],
...
export class OwnerTypesFormComponent implements OnInit {
  ...
  constructor(public akiSettings: AkiSettingsService, public akiroyaltyOwnerTypesService: AkiroyaltyOwnerTypesService) { }
