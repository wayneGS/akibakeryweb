...
@Component({
  selector: 'app-memberstatus-form',
  templateUrl: './memberstatusform.component.html',
  styleUrls: ['./memberstatusform.component.css'],
...
export class MemberStatusFormComponent implements OnInit {
  ...
  onSubmit(item){
    ...
    this.akiroyaltyMemberStatusService
      .putItem(item)
      .subscribe(data => {
          console.log(data);
