...
@Component({
  ...
  styleUrls: ['./groupsform.component.css'],
...
export class GroupsFormComponent implements OnInit {
  ...
  constructor(public akiSettings: AkiSettingsService, public akiroyaltyGroupsService: AkiroyaltyGroupsService) { }
