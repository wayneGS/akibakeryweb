...
@Component({
  selector: 'app-membertypes-form',
  templateUrl: './membertypesform.component.html',
  styleUrls: ['./membertypesform.component.css'],
...
export class MemberTypesFormComponent implements OnInit {
  ...
  constructor(public akiSettings: AkiSettingsService, public akiroyaltyOwnerTypesService: AkiroyaltyMemberTypesService) { }
  ...
  onSubmit(item){
    ...
    this.akiroyaltyOwnerTypesService
      .putItem(item)
      .subscribe(data => {
          console.log(data);
