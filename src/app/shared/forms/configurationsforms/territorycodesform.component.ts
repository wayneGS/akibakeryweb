...
@Component({
  selector: 'app-territorycodes-form',
  templateUrl: './territorycodesform.component.html',
  styleUrls: ['./territorycodesform.component.css'],
...
export class TerritoryCodesFormComponent implements OnInit {
  ...
  constructor(public akiSettings: AkiSettingsService, public akiroyaltyTerritoryCodesService : AkiroyaltyTerritoryCodesService ) { }
  ...
  onSubmit(item){
    ...
    this.akiroyaltyTerritoryCodesService 
      .putItem(item)
      .subscribe(data => {
          console.log(data);
